---
title: "The Inquiry That Booked Your Competitor"
date: 2026-07-03
description: "60% of law firms don't respond to email inquiries at all, and phone answer rates have fallen since 2019, per a 2024 secret-shop study of 500 firms. The math on what a slow first response costs a professional services firm, and the fix that doesn't require a receptionist."
story: 2
...
| Portion answered same-day, unprompted | 40% (per the phone-answer benchmark) |
...
This is the deals leak in the same three-leak framing as [the non-billable admin that eats your week](/articles/non-billable-admin-audit/) and [the engagement letter that goes out late](/articles/same-day-engagement-letters/) — inquiries, hours, and invoices are the three places a professional services firm loses money without anyone deciding to lose it. The [3-minute scorecard](/scorecard/) scores all three for your firm and tells you which one to fix first, alongside the [professional services use cases](/use-cases/) that map to each. Free, no call, no pitch.
